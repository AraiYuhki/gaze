...
**Hunk View 改善: 行単位ステージング + Visual モード** ← 完了
...
### 行単位ナビゲーション
- [x] j/k で全行を移動可能に（従来は hunk ヘッダ間のみ） <!-- 2026-02-06 -->
- [x] ファイルヘッダ行はスキップ <!-- 2026-02-06 -->

### 行単位ステージング
- [x] コンテンツ行上で `s` → その1行だけをステージ <!-- 2026-02-06 -->
- [x] hunk ヘッダ上で `s` → hunk 全体をステージ（従来動作維持） <!-- 2026-02-06 -->
- [x] Context 行上で `s` → メッセージ表示（ステージ不可） <!-- 2026-02-06 -->
- [x] `generate_partial_patch()` 関数を追加（テスト4件） <!-- 2026-02-06 -->

### Visual モード
- [x] `v` で範囲選択を開始、j/k で範囲を拡大、`s` で選択範囲をステージ <!-- 2026-02-06 -->
- [x] 別 hunk に跨がる選択はエラーメッセージで拒否 <!-- 2026-02-06 -->
- [x] Visual モード中に `Esc` → Visual 解除のみ（hunk モード継続） <!-- 2026-02-06 -->
- [x] UI: カーソルハイライトを全行に拡張、Visual 選択範囲を別色でハイライト <!-- 2026-02-06 -->
- [x] ヘルプ画面に Hunk Staging セクションを追加 <!-- 2026-02-06 -->

### 完了判定
```bash
cargo test && cargo clippy -- -D warnings && cargo fmt --check
```
- [x] **Hunk View 改善 完了** <!-- 2026-02-06 -->
